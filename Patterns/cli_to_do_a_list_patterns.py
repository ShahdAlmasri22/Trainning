import manage_task_patterns


def main():
    tasks= manage_task_patterns.ManageTask()
            ...
            match choice:
                ...
                case 3:
                    ...
                    if new_status not in ["1", "2"]:
                        ...
                        if (new_status == "1"):
                            tasks.update_status(id, manage_task_patterns.Status.PENDING)
                        else:
                            tasks.update_status(id, manage_task_patterns.Status.COMPLETED)
